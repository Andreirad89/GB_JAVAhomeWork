    ...
    public static void playerNextMoveAction(int lastPosX, int lastPosY, int nextPosX, int nextPosY) {
        if (invisibleRoom[nextPosY][nextPosX] == enemy) {
            ...
            do {
                ...
                System.out.println("Враг наносит удар " + enemyAttack + ". Player HP now is " + playerHP);
                enemyHP -= playerAttack;
                System.out.println("Игрок наносит удар в ответ" + playerHP + "." + "enemy HP now is " + enemyHP);
            }
        ...
        enemyHP = randomValue(enemyValueMin, enemyValueMax); //при прохождении первого врага HP у последующих начинаются со значения с пройденого, я добавил эту строку.
    }
